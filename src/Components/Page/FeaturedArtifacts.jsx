              ...
              <div key={artifact._id} className="max-w-xs rounded-md shadow-md dark:bg-gray-50 dark:text-gray-800">
	             ...
	             <div className="flex flex-col justify-between p-6 space-y-8">
                  ...
                  <div className="divider">Default</div> 
	             	<Link to={`/viewDitails/${artifact._id}`} type="button" className="flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md dark:bg-violet-600 dark:text-gray-50">Read more</Link>
	             </div>
        </div>
            ))
          }
